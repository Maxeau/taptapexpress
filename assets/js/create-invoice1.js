...
$(document).ready(function () {
    ...
    function renderInvoice(invoice) {
        ...
        $("#invoice_id").val(invoice.patient_id);
    ...
    $("#delete-patient-form").submit(function (event) {
        ...
        if (id != undefined) {
            ...
            checkbox.each(function () {
                db.collection('Invoices').doc(this.value).delete()
                    .then(function () {
                        console.log("Document successfully delete!");
                    })
                    .catch(function (error) {
    ...
    $(document).on('click', '.js-edit-patient', function () {
        ...
        db.collection('Invoices').doc(id).get().then(function (document) {
            if (document.exists) {
    ...
    $("#js-previous").on('click', function () {
        ...
        var previous = db.collection("Invoices")
    ...
    $('#js-next').on('click', function () {
        ...
        $('#patient-table tbody').html('');
        var next = db.collection("Invoices")
