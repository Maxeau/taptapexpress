...
//     if (!employee || !employee.isLoggedIn) {
     //    window.location.href = "login.html"
	// }
	
			console.log('profile image =>', employee.image_url);
            $('#profile-image').attr('src', employee.image_url);
            $('#profile-name').text(employee.full_name);
