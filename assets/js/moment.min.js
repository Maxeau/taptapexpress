...
!(function(a, b) {
  ...
  var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    pe = "Janvier_Fevrier_Mars_Avril_Mai_Juin_Juillet_Août_Septembre_Octobre_Novembre_Décembre".split(
      "_"
    ),
    qe = "Jan_Fev_Mar_Avr_Mai_Jun_Jul_Août_Sep_Oct_Nov_Dec".split("_"),
    re = be,
    se = be;
  U("Y", 0, 0, function() {
    var a = this.year();
  ...
  var ve = "Dimanche_Lundi_Mardi_Mercredi_Jeudi_Vendredi_Samedi".split(
      "_"
    ),
    we = "Dim_Lun_Mar_Mer_Jeu_Ven_Sam".split("_"),
