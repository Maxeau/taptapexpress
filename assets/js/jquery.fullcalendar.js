...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        var $this = this;
            ...
            form.find(".row")
                ...
                .append("<div class='col-md-6'><div class='form-group'><label>Categorie</label><select class='select form-control' name='category'></select></div></div>")
    ...
    CalendarApp.prototype.enableDrag = function() {
     ...
     .then(querySnapshot => {
         ...
         console.log('In the calendar =>', defaultEvents);
         querySnapshot.forEach(doc => {
            let time = ((doc.data().apt_date).seconds) * 1000;
            let date = moment(new Date(time)).format('ddd DD MMM YYYY HH:MM');
                 defaultEvents.push({title: doc.data().patient.full_name, start: date, className: 'bg-danger'});
         });
         $.CalendarApp.init();
     })
